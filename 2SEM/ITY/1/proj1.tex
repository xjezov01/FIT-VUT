...
%\subtitle{1. projekt}
\author{Filip Je¾ovica \\xjezov01@stud.fit.vutbr.cz}
%\email{xjezov01@stud.fit.vutbr.cz}
\date{}
...
Tí­mto pravidlem se \underline{nikdy} nesmí­te øí­dit. Pøíli¹ èasté zvýrazòování textových elementù a~zmìny {{\huge V}{\LARGE E}{\Large L}{\large I}{\normalsize K}{\small O}{\footnotesize S}{\scriptsize T}{\tiny I}} pí­sma {\Large jsou} {\LARGE známkou} {\huge \bfseries amatérismu} autora a~pùsobí­ {\bfseries \emph{velmi}} \emph{ru¹ivì}. Dobøe navr¾ený dokument nemá obsahovat ví­ce ne¾ 4 øezy èi druhy pí­sma. \texttt{Dobøe navr¾ený dokument je decentní­, ne chaotický}. 
